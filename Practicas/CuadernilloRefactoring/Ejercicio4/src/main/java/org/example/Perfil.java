...
public class Perfil {
    ...
    public void agregarPublicacion(Publicacion publicacion) { publicaciones.add(publicacion); } //Rename parameter: antes era 'p'
    ...
    public int alcance() { //Rename Method: antes era calcular()
